...
<div class="inline-block relative">
    <button @click="drop_down_open=!drop_down_open"
        ...
        :class="{'blue-ring':drop_down_open}"
    >
        <span><slot></slot></span>
    ...
    <ul v-show="drop_down_open"
        class="z-10 ui-dropdown-menu2 whitespace-nowrap absolute min-w-full drop-shadow-lg cursor-pointer"
        :class="alignclass"
        @click="menu_clicked"
    >
